...
| `QUAD_PUSH`  | idx0, idx1, idx2, idx3     | Pushes the value at the given index of the constant table to the top of the stack. Arguments form a 64-bit index. Used for constants that exceed 256. |
