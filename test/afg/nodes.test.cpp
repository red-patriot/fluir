...
TEST(TestNode, CompareSharedNodesDirectlyForEquality) {
  auto first = fafg::makeDependency(fafg::makeDoubleConstant(3.5));
  auto second = fafg::makeDependency(fafg::makeDoubleConstant(3.5));
...
TEST(TestNode, CompareSharedNodesDirectlyForEqualityWorksForDifferentTypes) {
  ...
  auto second = fafg::BinaryOp{
      fluir::Operator::STAR,
      fafg::makeDependency(fafg::makeDoubleConstant(1.0)),
      fafg::makeDependency(fafg::makeDoubleConstant(2.0))};
