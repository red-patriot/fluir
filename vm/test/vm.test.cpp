...
TEST(TestVM, ExecuteSimpleAddition) {
  fluir::code::ByteCode code{
    .header = {}, .chunks = {fc::Chunk{.code = {PUSH_FP, 0, PUSH_FP, 1, FP_ADD, EXIT}, .constants = {1.2, 2.5}}}};
  double expected = 3.7;
...
TEST(TestVM, ExecuteSimpleSubtraction) {
  fluir::code::ByteCode code{
    .header = {}, .chunks = {fc::Chunk{.code = {PUSH_FP, 0, PUSH_FP, 1, FP_SUBTRACT, EXIT}, .constants = {1.2, 2.5}}}};
  double expected = -1.3;
...
TEST(TestVM, ExecuteSimpleMultiply) {
  fluir::code::ByteCode code{
    .header = {}, .chunks = {fc::Chunk{.code = {PUSH_FP, 0, PUSH_FP, 1, FP_MULTIPLY, EXIT}, .constants = {1.2, 2.5}}}};
  double expected = 3.0;
...
TEST(TestVM, ExecuteSimpleDivide) {
  fluir::code::ByteCode code{
    .header = {}, .chunks = {fc::Chunk{.code = {PUSH_FP, 0, PUSH_FP, 1, FP_DIVIDE, EXIT}, .constants = {1.2, 2.5}}}};
...
TEST(TestVM, PushAndPopCorrectly) {
  fluir::code::ByteCode code{
    .header = {},
    .chunks = {fc::Chunk{.code = {PUSH_FP, 0, PUSH_FP, 1, FP_DIVIDE, POP, EXIT}, .constants = {1.2, 2.5}}}};
